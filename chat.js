...
function firstBotMessage() {
    let firstMessage = `Willkommen! Ich bin hier um Sie zu helfen! <br><br> Ich bin ein Chatbot und werde Sie unterstützen und Helfen Ihre Probleme zu lösen.<br><br> Ich freue mich auf Sie!`;
