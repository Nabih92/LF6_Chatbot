...
var linuxAntworte = `
        <p id="linuxAnswerers" style="text-align: center;">
            <button onclick="showFeedbackOnFAQ(this.id, this.parentNode.id)" class="Antwort1"><span>Definitionen und Überblick</span></button>
...
var feedbackOnFAQ = `
        <p id="feedbackOnFAQAnswerers" style="text-align: center;">
            <p class="botText"><span>Did you find an answer?</span><p>
            <button onclick="me(this.id, this.parentNode.id)" class="Antwort1" id="btn11"><span>Yes</span></button>
            <button onclick="me(this.id, this.parentNode.id)" class="Antwort1" id="btn12"><span>No</span></button>
        </p>`;
