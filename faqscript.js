...
.then(data => {
  for (let i = 0; i < data.Allgemein.length; i++) {
    ...
    <div class="accordion-item">
      <div class="accordion-item-header" id="LinuxFrage${i}">${data.Allgemein[i].Frage}</div>
  ...
  for (let i = 0; i < data.LinuxOS.length; i++) {
    let LinuxFAQ = `
    <div class="accordion-item">
      <div class="accordion-item-header">${data.LinuxOS[i].Frage}</div>
  ...
  for (let i = 0; i < data.WindowsOS.length; i++) {
    let WindowsOS = `
    <div class="accordion-item">
      <div class="accordion-item-header">${data.WindowsOS[i].Frage}</div>
      <div class="accordion-item-body">
  ...
  for (let i = 0; i < data.MacOS.length; i++) {
    let MacOSFAQ = `
    <div class="accordion-item">
      <div class="accordion-item-header">${data.MacOS[i].Frage}</div>
      <div class="accordion-item-body">
  ...
  for (let i = 0; i < data.InfrastrukturNetzwerke.length; i++) {
    let NetzwerkeFAQ = `
    <div class="accordion-item">
      <div class="accordion-item-header">${data.InfrastrukturNetzwerke[i].Frage}</div>
      <div class="accordion-item-body">
